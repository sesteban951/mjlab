...
register_mjlab_task(
  task_id="Mjlab-Tracking-Prior-BoxRolldown-Unitree-G1",
  env_cfg=unitree_g1_box_rolldown_prior_env_cfg(),
  play_env_cfg=unitree_g1_box_rolldown_prior_env_cfg(play=True),
  rl_cfg=unitree_g1_tracking_prior_ppo_runner_cfg(),
  runner_cls=MotionTrackingOnPolicyRunner,
)

register_mjlab_task(
  task_id="Mjlab-Tracking-Prior-Sideroll-Unitree-G1",
  env_cfg=unitree_g1_sideroll_prior_env_cfg(),
  play_env_cfg=unitree_g1_sideroll_prior_env_cfg(play=True),
  rl_cfg=unitree_g1_tracking_prior_ppo_runner_cfg(),
  runner_cls=MotionTrackingOnPolicyRunner,
)
